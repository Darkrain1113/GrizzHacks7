...
class NPC(AnimatedSprite):
    ...
    def check_health(self):
        if self.health < 1:
            ...
            # Store the killed enemy for potential respawn
            self.game.object_handler.store_killed_enemy(self)
            # Show coding question
            self.game.object_renderer.show_question(self.__class__.__name__)
